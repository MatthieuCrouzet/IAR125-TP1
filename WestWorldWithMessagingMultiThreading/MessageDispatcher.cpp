                                        ...
                                        void*  ExtraInfo)
{
  ...
  if (delay <= 0.0f)                                                        
  {
	  cout << "\nInstant telegram dispatched at time: " << Clock->GetCurrentTime()
		  << " by ";
	  switch (pSender->ID()) {
	  case ent_Boozer:		SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | FOREGROUND_BLUE);	break;
	  case ent_Elsa:		SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | FOREGROUND_GREEN);		break;
	  case ent_Miner_Bob:	SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | FOREGROUND_RED);	break;
	  }
	  cout << GetNameOfEntity(pSender->ID());
	  SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | BACKGROUND_INTENSITY);
	  cout << " for ";
	  switch (pReceiver->ID()) {
	  case ent_Boozer:		SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | FOREGROUND_BLUE);	break;
	  ...
	  cout << GetNameOfEntity(pReceiver->ID());
	  SetTextColor(BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_GREEN | BACKGROUND_INTENSITY);
      cout << ". Msg is "<< MsgToStr(msg);
